...
export interface PointSummary {
  ...
  backdoorFlushFlag?: number;
  straightOutCount?: number;
  openEndedStraightDrawFlag?: number;
  gutshotFlag?: number;
  doubleGutshotFlag?: number;
  comboDrawFlag?: number;
  removalGradientStdDev?: number;
  removalGradientMin?: number;
  removalGradientMax?: number;
  removalGradientL1?: number;
  removalGradientL2?: number;
  removalGradientPositiveMass?: number;
  removalGradientNegativeMass?: number;
  removalGradientAvailable?: number;
  removalGradientMean?: number;
  transitionEntropy?: number;
  transitionMaxProbability?: number;
  transitionDiagonalMass?: number;
  transitionUpgradeMass?: number;
  transitionDowngradeMass?: number;
  transitionRiverPairOrBetterMass?: number;
  transitionRiverFlushOrBetterMass?: number;
  categoryTransitionAvailable?: number;
