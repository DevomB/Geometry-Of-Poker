...
def summary_metrics_row(df: pd.DataFrame, row_idx: int, retained_cols: list[str]) -> dict[str, float]:
    ...
    mapping = {
        ...
        "equityVariance": sanitize_column("equityVariance"),
        "equityP05": sanitize_column("equityP05"),
        "equityP50": sanitize_column("equityP50"),
        "equityP95": sanitize_column("equityP95"),
        "equityRunoutAvailable": sanitize_column("equityRunoutAvailable"),
        "pNuts": sanitize_column("pNuts"),
        "pDominated": sanitize_column("pDominated"),
        "runoutVulnerabilityAvailable": sanitize_column("runoutVulnerabilityAvailable"),
        "flushOutCount": sanitize_column("flushOutCount"),
        "straightOutCount": sanitize_column("straightOutCount"),
        "improvementOutCount": sanitize_column("improvementOutCount"),
        "cleanImprovementOutCount": sanitize_column("cleanImprovementOutCount"),
        "drawFeaturesAvailable": sanitize_column("drawFeaturesAvailable"),
        "boardConnectivityScore": sanitize_column("boardConnectivityScore"),
        "boardRainbowFlag": sanitize_column("boardRainbowFlag"),
        "boardTwoToneFlag": sanitize_column("boardTwoToneFlag"),
        "boardMonotoneFlag": sanitize_column("boardMonotoneFlag"),
        "boardPairednessScore": sanitize_column("boardPairednessScore"),
